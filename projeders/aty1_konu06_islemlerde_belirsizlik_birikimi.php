...
<h2>6. İşlemlerde Belirsizlik Birikimi</h2> (Son düzenleme: <font color="red">17.12.2021</font>)<font size=4>
...
<p>Görüldüğü gibi oransal hata, bu durumda parametrelerin değerlerinden bağımsız, sadece onlardaki oransal belirsizliklere bağlı. 6.2.2 başlığı altında, belirsizlik oranlarının toplandığının söylenme nedeni de budur.</p>
</body>
</html>