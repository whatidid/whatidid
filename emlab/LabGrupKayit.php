<html>
	...
	<body bgcolor="#33CCFF">
	<b><font color="#FF0000">20.4.2015</font></b>
	<div class="Aciklama">
		<p>
		Elektrik Makinaları Laboratuvarı pazartesi 13.00 ve 15.00 grupları benim dersimle çakıştığı için bu grupları Tolga hoca dönene kadar ya da belki tamamen değiştiriyoruz. Çarşamba 15.00 grubunu da yer açmak için çarşamba 14.30'a çekiyoruz.</br>Diğer gruplarda bir değişiklik olmayacaktır.</br>B ve C grupları yerine açılması düşünülen gruplar aşağıdaki gibidir. Sıralı en az 3 tercih yapınız. Ders çakışması vb nedenle uymayan grupların hangi dersinizle çakıştığını özel notunuzda belirtiniz. Aksi halde hiç istemediğiniz bir gruba düşebilirsiniz. Tercih sıranız önemlidir.</p>
<p>		Buradaki işlem kesin kayıt değil, kayıt başvurusudur. Şu anda görüntülenen liste de kesin liste değildir. Kesin listeler 24 Nisan 2015 Cuma gününe kadar açıklanacaktır.		</p>
<p> F grubu: Pazartesi 20.00-21.15</br>
G grubu: Çarşamba 15.45-17.00</br>
H grubu: Çarşamba 20.00-21.15</br>
J grubu: Perşembe 20.00-21.15</br>
</p>
		<p>Deneyler <font color="#FF0000">27 Nisan 2015 Pazartesi</font> günü yeniden başlayacaktır.</p>
<p>Bu açıklamaları dikkate alarak aşağıdaki formu <font color="#FF0000">22 Nisan 2015 Çarşamba</font> gününe kadar doldurup 1 defa gönderiniz. Erken başvurulara imkânlar ölçüsünde öncelik verilecektir. Tercihlerini değiştirmek isteyen yeniden giriş yapabilir; bu durumda önceki başvuruları iptal edilir. Ayrıca e-posta atmanıza gerek yoktur. Kayıt başvurunuz aşağıda görülecektir.</p>
	</div>
	
<?php

	define(GMT_TURKIYE_FARKI, 0);
	...
	$uyari = "<p>";
	$uyari .= " Listenin, tarafımdan en son incelenme zamanı :  20 Nisan 2015 <code>Saat : 17.00</code>";
	$uyari .= "</p>";
	...
	//		$toplamdaYazilan .= '	</p><!-- /KaydedilenMetin -->';
			$toplamdaYazilan .= '	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; (<code class="Tarih">'.date("d.m.Y", time() + (GMT_TURKIYE_FARKI * 3600 + 40)).' Saat: '.date("G.i", time()+ (GMT_TURKIYE_FARKI * 3600 + 40)).'</code><!-- /Tarih -->)';
	//		$toplamdaYazilan .= '</blockquote><!-- /KayitAl -->
			$toplamdaYazilan .= '</p>';
