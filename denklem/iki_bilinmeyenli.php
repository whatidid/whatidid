 ...
 <body>
  <div class="ana">
   ...
   <?php
	...
	echo "<br>"; 
	if($toplamXIki== 0 and $toplamYIki== 0) echo " <script> window.location='iki_bilinmeyenli.php'; </script>";
	if($toplamSabIki==0) echo " <script> window.location='iki_bilinmeyenli.php'; </script>";
	echo '
	<div class="cevap">
	...
	echo "<br>";
	if($toplamXIki2== 0 and $toplamYIki2== 0) echo " <script> window.location='iki_bilinmeyenli.php'; </script>";
	if($toplamSabIki2==0) echo " <script> window.location='iki_bilinmeyenli.php'; </script>";
	echo '
	<div class="cevap">
   ...
   ?>
   <table>
    <td><form action="iki_bilinmeyenli.php" method="post">
     &nbsp; &nbsp; &nbsp; &nbsp;<input type="submit" value="Yeni İKİ bilinmeyenli"/>
	</form></td>
	<td><form action="tek_bilinmeyenli.php" method="post">
