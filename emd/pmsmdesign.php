<html>
 <head>
  <title>PMSM DESIGN FOR SIMULATION PURPOSES</title>
  <meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-9" />
 </head>
 <body bgcolor="#33CCFF" text="#000000">
  <p>Last modified on 08.6.2019.<br><font color="#FF0000"><b>PMSM DESIGN FOR SIMULATION PURPOSES</b> (3-phase)</font></p>
  <p>This page serves a free online permanent magnet synchronous motor design tool for simulation purposes according to the following model:<br>
  <img src="PMSMmodel.png" alt=" PMSM Model"></p>
  ...
  <form action="" method="post">
   ...
   Saliency ratio = k<sub>dq</sub> = L<sub>sd</sub> / L<sub>sq</sub> = <input type="text" name="kdq" size="5"/>&nbsp; &nbsp;(e.g. 1.6666666666) <font color="#FF0000"><b>(1 for cylindrical rotor)</b></font><br>
  ...
  <?php
    if (isset($_POST['Design'])) {
      ...
      if ($mistake) {echo '<br>DESIGN IS UNSUCCESSFUL FOR THE ABOVE REASON(S)</b></font>';}
        ...
        echo 'Inertia <b>J<sub>i</sub> = '.$Ji.'<font color="#990000">kg.m<sup>2</sup></font></b><br>';
        echo 'Permanent magnet\'s flux linkage on stator <b>&Phi;<sub>PM</sub> = '.$FIPM.'<font color="#990000">Vs</font></b></p>';
        ...
        //echo 'PM torque / Electromechanical torque = <b>k<sub>TPM</sub> = '.$kTPM.'</b>';
        //if ($kdq==1) echo '<font color="#FF0000"> (demand value)</font>';
        echo '</p>';
//		echo '<p>Number of successful pmsm designs by visitors since 2nd December 2019 is ';
//		echo '<a class="hitCounter" href="https://visitorshitcounter.com/" target="_blank" rel="nofollow noopener" title="Hit counter" data-name="fc1d670dc2644f7a3d5fd70f7bc27c16|5|page|1|#ea5050|#ffffff|small|s-hit">Hit Counter</a><script>document.write("<script type=\'text/javascript\' src=\'https://visitorshitcounter.com/js/hitCounter.js?v="+Date.now()+"\'><\/script>");</script>';
      }
    }
  ?>
<br><br><br><br><br>
...
Online permanent magnet synchronous motor parameters for simulation purposes<br>
Online PMSM parameters for simulation purposes<br>
...
Online permanent magnet synchronous motor design for simulation purposes<br>
Online PMSM design for simulation purposes<br>
</font>
 </body>
</html>