<html>
	...
	<div class="Aciklama">
		<p>
			Elektrik Makinaları Laboratuvarı grupları aşağıdaki gibi düşünülmektedir. Bunlardan yalnızca 4'ü açılacak, talep az olan 2'si açılmayacaktır. Bu nedenle mutlaka en az 3 (A ve C dışında en az 2) tercih yapınız. Aksi halde hiç istemediğiniz bir gruba düşebilirsiniz. Tercih sıranız önemlidir. 
		</p>
		<p>	
...
<?php
	...
	$uyari = "<p>";
	$uyari .= " Listenin, tarafımdan en son incelenme zamanı :  03 Mart 2008 <code>Saat : 11.00</code>";
	$uyari .= "</p>";
